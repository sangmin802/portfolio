      ...
      <div className="portImg">
        <div className="pc">
          <div className="pcImgWrap imgWrap">
            {pcImg.map((res, index) => {
              return (
                <img className={`img pcImg pcImg${index}`} key={res} data-src={`https://github.com/sangmin802/portfolio/blob/master/public/img/${res}`} alt={res}
        ...
        <div className="mobile">
          <div className="mobileImgWrap imgWrap">
            {mobileImg.map((res, index) => {
              return (
                <img className={`img mobileImg mobileImg${index}`} key={res} data-src={`https://github.com/sangmin802/portfolio/blob/master/public/img/${res}`} alt={res}
                  onMouseDown={this.slideMouseDown.bind(this)}
                  onMouseMove={this.slideMouseMove.bind(this)}
                  onMouseUp={this.slideMouseOut.bind(this)}
                  onMouseOut={this.slideMouseOut.bind(this)}
          ...
          <div className="pcImgWrap imgWrap">
            {pcImg.map((res, index) => {
              ...
              if(res.includes('artbox')){
                src = `https://github.com/sangmin802/portfolio/blob/master/public/img/${res}`;
              }
              return (
                <img className={`img pcImg pcImg${index}`} key={res} src={src} data-src={`https://github.com/sangmin802/portfolio/blob/master/public/img/${res}`} alt={res}
                  onMouseDown={this.slideMouseDown.bind(this)}
                  onMouseMove={this.slideMouseMove.bind(this)}
                  onMouseUp={this.slideMouseOut.bind(this)}
                  onMouseOut={this.slideMouseOut.bind(this)}
      ...
      <div className="portImg">
        <div className="onlyMobile">
          <div className="fullMobileImgWrap imgWrap">
            {mobileImg.map((res, index) => {
              return (
                <img className={`img fullMobileImg mobileImg${index}`} key={res} data-src={`https://github.com/sangmin802/portfolio/blob/master/public/img/${res}`} alt={res}
                  onMouseDown={this.slideMouseDown.bind(this)}
                  onMouseMove={this.slideMouseMove.bind(this)}
                  onMouseUp={this.slideMouseOut.bind(this)}
                  onMouseOut={this.slideMouseOut.bind(this)}
